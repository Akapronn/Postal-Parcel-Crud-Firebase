package th.ac.kku.cis.project50
...
import th.ac.kku.cis.myfinal.User
import th.ac.kku.cis.project50.databinding.ActivityUploadBinding
...
class UploadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.saveButton.setOnClickListener {
            ...
            database = FirebaseDatabase.getInstance().reference.child("postal parcel number")
